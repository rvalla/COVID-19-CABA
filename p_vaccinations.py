...
def plot_total_vac_by_sex():
	...
	cum_age_sex["TotalM"][cc.start_date:].plot(kind='line', label=chart_texts[3], color=cc.colors[0], linewidth=2.5)
	cum_age_sex["TotalF"][cc.start_date:].plot(kind='line', label=chart_texts[4], color=cc.colors[1], linewidth=2.5)
	cum_age_sex["Total"][cc.start_date:].plot(kind='line', label=chart_texts[5], color=cc.colors[2], linewidth=2.5)
...
def plot_total_vac_by_dose():
	...
	cum_age_dose["TotalA"][cc.start_date:].plot(kind='line', label=chart_texts[3], color=cc.colors[0], linewidth=2.5)
	cum_age_dose["TotalB"][cc.start_date:].plot(kind='line', label=chart_texts[4], color=cc.colors[1], linewidth=2.5)
	cc.build_texts(chart_texts[0], chart_texts[1], chart_texts[2])
	cc.build_legend()
	cc.grid_and_ticks(1, 3)
...
def plot_doses_by_age():
	...
	for i in range(len(age_groups)):
		age_dose[age_groups[i]][cc.start_date:].plot(kind='line', label=age_groups[i], color=cc.colors[i], linewidth=2.5)
	cc.build_texts(chart_texts[0], chart_texts[1], chart_texts[2])
	cc.build_legend()
	cc.grid_and_ticks(1, 3)
...
def plot_doses_by_age_avg():
	...
	for i in range(len(age_groups)):
		age_dose_avg[age_groups[i]][cc.start_date:].plot(kind='line', label=age_groups[i], color=cc.colors[i], linewidth=2.5)
	cc.build_texts(chart_texts[0], chart_texts[1], chart_texts[2])
	cc.build_legend()
	cc.grid_and_ticks(1, 3)
...
def plot_doses_by_vac_avg():
	...
	for i in range(len(vaccines)):
		vac_dose_avg[vaccines[i]][cc.start_date:].plot(kind='line', label=vaccines[i], color=cc.colors[i], linewidth=2.5)
	cc.build_texts(chart_texts[0], chart_texts[1], chart_texts[2])
	cc.build_legend()
	cc.grid_and_ticks(1, 3)
