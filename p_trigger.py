...
cases.plot_cases_by_age_avg(0, 0, 500, 1, 5, 1, cc)
cases.plot_cases_by_zone_avg(0, 0, 75, 1, 1, 1, cc)
...
#Building cases charts
cases.plot_total_avg(0, 0, 1500, 1, 10, 1, cc)
cases.plot_cases_by_age_avg(0, 0, 500, 1, 5, 1, cc)
cases.plot_cases_by_zone_avg(0, 0, 150, 1, 5, 1, cc)
...
#Building cases charts
cases.plot_total_avg(0, 0, 1500, 1, 1, 1, cc)
cases.plot_cases_by_age_avg(0, 0, 500, 1, 1, 1, cc)
cases.plot_cases_by_zone_avg(0, 0, 150, 1, 1, 1, cc)
