...
cases.plot_total_cases(0, 0, 150000, 1000, 2500, 1000)
...
sis.plot_estimation_avg(0, 0, 2000, 1000, 0.5, 1)
sis.plot_estimation(0, 0, 500000, 1000000, 0.1, 1)
...
sis.plot_origin_ratios(0, 0, 0.15, 0.25, 0.05, 0.05)
